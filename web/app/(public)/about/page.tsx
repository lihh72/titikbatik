...
export default function AboutPage() {
  return (
    <main className="mx-auto max-w-7xl px-4 pb-8 sm:px-6 lg:px-8">
      ...
      <section id="sumber-visual" className="archive-panel mt-7 rounded-[32px] p-7 sm:p-9">
        <h2 className="text-2xl font-semibold">Sumber visual</h2>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-white/48">Gambar dokumenter digunakan sesuai lisensi dan kredit sumber yang tersedia. Visual konseptual yang dibuat dengan bantuan AI diberi label agar asalnya dapat dikenali dengan jelas.</p>
      </section>
    </main>
  );
}
