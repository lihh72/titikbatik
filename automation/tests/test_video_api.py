...
from tests.helpers import AUTOMATION_ROOT
...
def test_admin_web_contains_video_controls_and_preview():
    html = (AUTOMATION_ROOT / "app/web/index.html").read_text(encoding="utf-8")
    javascript = (AUTOMATION_ROOT / "app/web/static/admin.js").read_text(encoding="utf-8")
